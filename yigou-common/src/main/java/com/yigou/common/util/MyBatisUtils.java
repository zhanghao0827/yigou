...
public class MyBatisUtils {
    ...
    // 获取bean的属性 根据属性评价 resultMap
    // 并将驼峰修改为'_'
    public static String getResultMapUnderscoreToCamelCase(Class<?> cls) throws Exception {
        String str = "";
    ...
    public static String getResultMapUnderscoreToCamelCase2(Class<?> cls) throws Exception {
        String str = "";
        // 头部 <resultMap id="BaseResultMap" type="com.huajie.entity.sys.SysMenuinfo">
        str = "<resultMap id=\"" + cls.getSimpleName() + "ResultMap" + "\"" + " type=\"" + cls.getName() + "\"> \r\n";
        // 每一行字符串
    ...
    public static void main(String[] args) throws Exception {
        System.out.println(getResultMapUnderscoreToCamelCase2(Address.class));
    }
